...
class Slider {
  constructor(props) {
    ...
    this.slides = Array.from(
      this.rootElement.querySelectorAll(".slider-list-item")
    );
    ...
    this.navBar = this.rootElement.querySelector(".slider-nav-bar");
    this.thumbs = Array.from(this.rootElement.querySelectorAll(".nav-control"));
    this.prevButton = this.rootElement.querySelector(".slider-arrow_prev");
    this.nextButton = this.rootElement.querySelector(".slider-arrow_next");

    this.slides[this.current].classList.add("slider-list-item_active");
  ...
  goTo(index, dir) {
    ...
    self.current = index;
    nextSlide.classList.add("slider-list-item_active");
    ...
    anime(Object.assign({}, self.baseAnimeSettingsBack, {
      targets: nextSlide.querySelectorAll('.back-element'),
      rotate: [90 * dir + 'deg', 0],
      translateX: [90 * dir + '%', 0]
    }));

    anime(Object.assign({}, self.baseAnimeSettingsFront, {
      targets: nextSlide.querySelectorAll('.front-element'),
      rotate: [90 * dir + 'deg', 0],
      translateX: [90 * dir + '%', 0]
    }));
    
    anime(Object.assign({}, self.baseAnimeSettingsTitle, {
      targets: nextSlide.querySelectorAll('.title-element'),
      rotate: [90 * dir + 'deg', 0],
      translateX: [90 * dir + '%', 0]
    }));
    ...
    anime(Object.assign({}, self.baseAnimeSettingsBack, {
      targets: prevSlide.querySelectorAll('.back-element'),
      rotate: [0, -90 * dir + 'deg'],
      translateX: [0, -100 * dir + '%']
    }));

    anime(Object.assign({}, self.baseAnimeSettingsFront, {
      targets: prevSlide.querySelectorAll('.front-element'),
      rotate: [0, -90 * dir + 'deg'],
      translateX: [0, -100 * dir + '%']
    }));

    anime(Object.assign({}, self.baseAnimeSettingsTitle, {
      targets: prevSlide.querySelectorAll('.title-element'),
      rotate: [0, -90 * dir + 'deg'],
      translateX: [0, -100 * dir + '%']
    }));
